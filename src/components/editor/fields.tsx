  ...
  return (
    <label className="block mb-3">
      ...
      <input
        ...
        className="w-full rounded-md border border-white/15 bg-black/30 px-3 py-2 text-sm text-cream outline-none focus:border-mint/60"
      />
    </label>
  );
}
  ...
  return (
    <label className="block mb-3">
      ...
      <textarea
        ...
        rows={rows}
        onChange={(e) => onChange(e.target.value)}
        className="w-full resize-y rounded-md border border-white/15 bg-black/30 px-3 py-2 text-sm text-cream outline-none focus:border-mint/60"
      />
    </label>
  );
}
        ...
        {items.map((item, i) => (
          <div key={i} className="flex gap-1.5">
            <input
              ...
              className="flex-1 rounded-md border border-white/15 bg-black/30 px-3 py-1.5 text-sm text-cream outline-none focus:border-mint/60"
            />
            <button
              type="button"
        ...
        {rows.map((row, i) => (
          <div key={i} className="flex gap-1.5">
            ...
            <input
              ...
              className="w-40 rounded-md border border-white/15 bg-black/30 px-3 py-1.5 text-sm text-cream outline-none focus:border-mint/60"
            />
            <button
              type="button"
